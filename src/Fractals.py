...
class BurningShip2D(Fractal2D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/burningship2d.frag",
    }
...
class Mandelbrot2D(Fractal2D):
    default_settings = {
        ...
        "HIGH_SCR_QUALITY": False,
        "HIGH_VIDEO_QUALITY": False,
        "SHADER_SRC": "res/shaders/mandelbrot2d.frag",
    }
...
class Julia2D(Fractal2D):
    default_settings = {
        ...
        "HIGH_SCR_QUALITY": False,
        "HIGH_VIDEO_QUALITY": False,
        "SHADER_SRC": "res/shaders/julia2d.frag",
    }
...
class Mandelbrot3D(Fractal3D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/mandelbrot3d.frag",
...
class Julia3D(Fractal3D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/julia3d.frag",
...
class Mandelbrot4D(Mandelbrot3D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/mandelbrot4d.frag",
...
class Julia4D(Julia3D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/julia4d.frag",
...
class Mandelbox(Fractal3D):
    default_settings = {
        ...
        "SHADER_SRC": "res/shaders/mandelbox.frag",
    }
